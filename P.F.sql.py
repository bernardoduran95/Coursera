...
alumno1=Estudiante(nombrea='Veronica', apellidoa=' Monzon')
print(alumno1)
session.add(alumno1)
alumno1.cursos=Course(nombrec='Coursera')
print(alumno1.cursos)

horario1=Crono(dia='lunes',hora_inicio="7:00 am", hora_fin='8:00')
session.add(horario1)
horario1.curso_hora=Course(nombrec='SQL')
horario1.curso_profe=Maestro(nombrep='Agustin',apellidop=' Lavarello')
